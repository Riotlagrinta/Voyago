...
> > La base de données PostgreSQL locale tourne sur **Docker**.
...
|--------------|--------|------|
| `web` — `npm run build` | ✅ (0 Erreur TS) | 2026-07-12 |
| `web` — `npm run lint` | ✅ | 2026-07-12 |
| `api` — `npm run build` | ✅ (0 Erreur TS) | 2026-07-12 |
| `api` — `npm test` | ✅ (11/11 tests passés) | 2026-07-12 |
