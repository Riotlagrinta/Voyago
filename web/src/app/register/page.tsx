  ...
  return (
    <Card className="w-full max-w-md p-8 shadow-voyago border-none rounded-3xl">
      <div className="text-center mb-8">
        ...
        <p className="text-foreground/60">Rejoignez-nous pour simplifier vos voyages.</p>
      </div>
...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center p-6">
      ...
      <Suspense fallback={<div className="w-full max-w-md h-96 bg-surface rounded-3xl animate-pulse" />}>
        <RegisterForm />
      </Suspense>
